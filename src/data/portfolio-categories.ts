...
export interface PortfolioCategoryBase {
...
/**
 * Base category metadata (non-textual). Titles/descriptions are localized via
 * the i18n dictionary in getPortfolioCategories(locale).
 */
export const portfolioCategories: PortfolioCategoryBase[] = [
  {
    id: 'ecommerce',
    gradient: 'amber',
